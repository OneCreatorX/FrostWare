...
local cur="Main"
local mainContent=""
local hdr=x("fr",ed,{n="EdTabs",bs=0,bc=C.w,bt=1,sz=u(contentXScale,0,HEADER_H,0),ps=u(MARGIN,0,headerY,0)})
x("uc",hdr,{cr=D(0.18,0)})
x("us",hdr,{ar=E.a,th=1})
local hll=Instance.new("UIListLayout")
hll.Parent=hdr
hll.FillDirection=Enum.FillDirection.Horizontal
hll.HorizontalAlignment=Enum.HorizontalAlignment.Left
hll.Padding=D(0,6)
...
local pv=x("fr",ov2,{n="EdAddPv",bs=0,bc=C.g2,bt=0,sz=u(0,300,0,140),ps=u(0.5,-150,0.5,-70),zi=1000})
x("uc",pv,{cr=D(0.24,0)})
x("us",pv,{ar=E.a,th=1})
...
nb[M.bc]=C.t1
nb[M.bt]=0
nb[M.sz]=u(0.86,0,0,34)
nb[M.ps]=u(0.07,0,0.22,0)
nb[M.tc]=W
nb[M.tfx]=E.lx
nb[M.tfy]=E.ly
nb[M.txs]=15
...
local plus=mkbtn(hdr,"Plus","+",u(0,26,1,0),u(0,0,0,0),2147480000,function()nb.Text=""ov2[M.v]=true end)
x("uc",plus,{cr=D(1,0)})
plus.LayoutOrder=2147480000
y(blk,function()ov2[M.v]=false end)
...
local bar=x("fr",ed,{n="EdBar",bs=0,bc=C.w,bt=1,sz=u(contentXScale,0,BAR_H,0),ps=u(MARGIN,0,barY,0)})
x("uc",bar,{cr=D(0.16,0)})
x("us",bar,{ar=E.a,th=1})
