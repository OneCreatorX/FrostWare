...
hb.Size = UDim2.new(0, 90, 0, 35)
hb.Position = UDim2.new(0, 230, 0, 150)
...
xb.Size = UDim2.new(0, 40, 0, 35)
xb.Position = UDim2.new(1, -80, 0, 150)
...
hb.MouseButton1Click:Connect(function()
    ...
    st.TextColor3 = Color3.fromRGB(59, 130, 246)
end)
